    ...
    translation: {
      ...
      errors: {
        ...
        profile: {
          ...
          'in-use': '当前角色仍被 {{templateCount}} 个工作流模板、{{taskCount}} 个任务工作流和 {{runCount}} 个可继续运行快照引用，暂时不能删除。',
        },
        'manual-check': {
      ...
      contextManagement: {
        ...
        deleteProfileDescription: '删除「{{name}}」后，它将不再出现在角色列表和工作流选择器中。若仍被引用则无法删除。',
        deleteProfileAction: '删除角色',
        deleteProfileBlockedByReferences: '当前角色仍被 {{targets}} 引用，暂时不能删除。',
    ...
    translation: {
      ...
      errors: {
        ...
        profile: {
          ...
          'in-use': 'This role is still referenced by {{templateCount}} workflow templates, {{taskCount}} task workflows, and {{runCount}} resumable run snapshots, so it cannot be deleted.',
        },
        'manual-check': {
      ...
      contextManagement: {
        ...
        deleteProfileDescription: 'After deleting “{{name}}”, it will no longer appear in the role list or workflow picker. Referenced roles cannot be deleted.',
        deleteProfileAction: 'Delete Role',
        deleteProfileBlockedByReferences: 'This role is still referenced by {{targets}} and cannot be deleted yet.',
