...
`presets/workflows/` 和 `presets/profiles/` 存放跨项目复用的 workflow / profile 预设。
...
## 11. AI worker / verify attempt 结构
...
`exec` 节点的执行产物全部由 runtime 生成，并位于 user project runtime store。
